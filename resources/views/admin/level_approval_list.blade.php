...
@section('title','Unapproved Access Level')
@section('css')
            ...
            <div class="row no-gutters">
                <div class="col-6">
                    <h4 class="m-t-5">
                        ...
                        Unapproved Access Level Listing
                    </h4>
                </div>
            </div>
        </div>
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc" tabindex="0" rowspan="1" colspan="1">Username</th>
                                        <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Level Proof</th>
                                        <th class="sorting wid-15" tabindex="0" rowspan="1" colspan="1">Updated At</th>
    ...
    <script>
        ...
        var table = $('#editable_table');
                table.DataTable({
                        ...
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": base_url + 'admin/fetchUnapprovedLevelUser',
                        "columnDefs": [
