                    ...
                    <div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group row m-t-25">
                                    <div class="col-lg-3 text-lg-right">
                                        <label for="upload_pdf" class="col-form-label">Upload Video Thumbnail</label>
                                    </div>
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group">
                                            <input id="input-22" name="thumbnail" type="file" class="file-loading" >
                                            @if(isset($course->id) &&  public_path('/images/thumbnail/'))
                                                <img src="{{ asset('public/images/thumbnail/' . $course->thumbnail) }}" height="100" width="100">
											@endif
                                        </div>
