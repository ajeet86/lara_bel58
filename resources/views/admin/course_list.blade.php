            ...
            <div class="card">
                ...
                <div class="card-block m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="{{url('admin/course')}}" id="editable_table_new" class=" btn btn-default">
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting wid-25 noExport" tabindex="0" rowspan="1" colspan="1">Category</th>
                                        <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Title</th>
                                        <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Level</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            table.DataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": base_url + 'admin/fetchCourses',
                "columnDefs": [
