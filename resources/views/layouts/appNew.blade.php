...
<html lang="en">
  <head>
    ...
    <link href="{{asset('public/sites/videoplayerlist/rvslider.min.css')}}" rel="stylesheet">
    <style>
	.rvs-item-container{
	height: 100%;
	...
	.rvs-xs.rvs-sm.rvs-md .rvs-nav-container a.rvs-nav1-item{
	height: 78px;
    padding: 8px 16px;
  		...
  		<div class="container">	
	  		...
	  		<div class="navbar_menu">
	  			...
	  			<ul class="pull-left menu">	
					...
					<li><a href="{{ url('/videoplaylist') }}">VIDEO PLAYLIST</a></li>
  ...
  <script src="{{asset('public/sites/videoplayerlist/rvslider.min.js')}}"></script>
